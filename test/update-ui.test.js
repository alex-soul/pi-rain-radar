...
test('browser reloads after an app upgrade, waits for Settings to close and ignores transient outages',async()=>{
  ...
  const context=vm.createContext({updateCloudSettings(){},acceptIntegrationStatus,recordConnection(){},historyWindow:null,historyLoading:false,appVersion:'0.1.1',mapIdentity:'map',AbortSignal,
