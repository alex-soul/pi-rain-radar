...
const messages = {
  ...
  'forecast-error': ['Rain forecast', 'warning', 'The latest forecast could not be acquired. The chart is cleared; retrying automatically.'],
  'forecast-gaps': ['Rain forecast', 'warning', 'The latest forecast contains missing minutes, shown in amber. Waiting for the next update.'],
  ...
  'weather-ready': ['Weather', 'info', 'Weather and Rain forecast connection ready.'],
  'weather-recovered': ['Weather', 'info', 'Weather and Rain forecast updates recovered.'],
