...
- **microSD card: [32GB A1](https://thepihut.com/products/sandisk-microsd-card-class-10-a1)** — 32 GB should be plenty based on current storage usage. I use a 64 GB A2-rated card.
